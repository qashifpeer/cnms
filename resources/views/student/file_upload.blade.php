...
<style>
  ...
  dl, ol, ul {
    ...
    <div class="container upload mt-5">
        <form action="{{route('StdFileUpload')}}" method="post" enctype="multipart/form-data">
          @csrf
          <h3 class="text-center mb-5">Upload File in Laravel</h3>
          <h5>Logged In As:{{ Auth::guard('student')->user()->user_type }}</h5>
          ...
          @endif
          <input type="hidden" name="user_type" value="{{ Auth::guard('student')->user()->user_type }}">
