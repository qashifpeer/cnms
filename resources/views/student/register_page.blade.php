...
<head>
    ...
    <!--Page title-->
    <title>CNMS Student Register</title>
    <!--bootstrap-->
        ...
        <div class="content_wrapper">
            ...
            <div class="registration_page center_container">
                <div class="center_content">
                    ...
                    <form action="{{ route('student.registerCreate') }} " method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            <a class="registration" href=" {{ route('student_login') }}">Already have an account</a><br>
